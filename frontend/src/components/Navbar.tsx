...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-slate-900 border-b border-slate-800 text-white shadow-md">
      {/* Top Status Bar */}
      <div className="bg-slate-950 px-4 py-1 text-[11px] font-medium text-slate-300 border-b border-slate-800 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span className="w-2 h-2 rounded-full bg-emerald-400 inline-block" />
          <span>National Digital Health Initiative • Portable Health Passport Architecture</span>
        </div>
        <div className="text-[11px] text-slate-400">
          Secure Session Active • 256-Bit SSL Protected
        </div>
      </div>
